odoo.define('website.s_EmployeeDetail', function (require) {
    'use strict';
    
    const options = require('web_editor.snippets.options');
    const s_dynamic_snippet_options = require('website.s_dynamic_snippet_options');
    
    const dynamicSnippetEmployeeCarouselOptions = s_dynamic_snippet_options.extend({
        /**
         * @override
         */
        onBuilt() {
            ...
            this.$target[0].dataset['snippet'] = 's_EmployeeDetail';
        },
    ...
    options.registry.dynamic_snippet_employees_carousel = dynamicSnippetEmployeeCarouselOptions;
    
    return dynamicSnippetEmployeeCarouselOptions;
    });
